  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1>Dashboard</h1>
          <p>Live overview of all monitored projects and websites</p>
        </div>
      </div>
      ...
      {projects.length === 0 ? (
        <div className="panel">
          <div className="empty">
            ...
            <p>Add your first project and website to start monitoring.</p>
        ...
        projects.map((section) => (
          <div className="panel" key={section.project.id}>
            <div className="panel-header">
              ...
              <div className="meta">
                {section.operational} / {section.total} websites operational
              </div>
            </div>
