...
def build_down_email(context: dict) -> tuple[str, str, str]:
    ...
    subject = f"🚨 WEBSITE DOWN | {project} | {website}"
...
<body>
  <div class="card">
    ...
    <div class="body">
      ...
      <div class="row"><span class="label">Website</span><span class="value">{website}</span></div>
...
def build_recovery_email(context: dict) -> tuple[str, str, str]:
    project = context.get("project_name", "")
    website = context.get("website_name", "")
    subject = f"✅ WEBSITE RECOVERED | {project} | {website}"
