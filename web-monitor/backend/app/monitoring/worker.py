...
from app.monitoring.checker import CheckResult, check_website
...
class MonitoringWorker:
    ...
    async def tick(self) -> None:
        ...
        async with self._tick_lock:
            ...
            due = self.websites_store.get_due_websites(now_iso)

            # Skip websites whose project is disabled
            due = [
                w
                for w in due
            ...
            tasks = [self._check_one(w, projects.get(w.project_id), now) for w in due]
