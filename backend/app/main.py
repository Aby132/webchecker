...
from app.api import apis, dashboard, logs, projects, settings, websites
...
app = FastAPI(
    title="Web Monitor",
    description="Self-hosted website and API uptime monitoring (filesystem storage, no database)",
    version="1.0.0",
    lifespan=lifespan,
)
