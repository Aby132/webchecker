...
export const getApis = (projectId) =>
  api.get('/apis', { params: projectId ? { project_id: projectId } : {} }).then((r) => r.data)
export const createApi = (data) => api.post('/apis', data).then((r) => r.data)
export const updateApi = (id, data) => api.put(`/apis/${id}`, data).then((r) => r.data)
export const deleteApi = (id) => api.delete(`/apis/${id}`).then((r) => r.data)
export const getApiDetails = (id, range = '24h') =>
  api.get(`/apis/${id}/details`, { params: { range } }).then((r) => r.data)
